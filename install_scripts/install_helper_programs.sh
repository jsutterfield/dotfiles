...
install_on_ubuntu() {
  echo "install these programs manually, or update the script to make it work better: fzf ripgrep fd-find broot tldr bat autojump"
}

# Function to install packages on MacOS
install_on_mac() {
  brew update
  brew install fzf ripgrep fd broot tldr bat autojump
}
